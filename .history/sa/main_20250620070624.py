...
def setup_logging(verbose: bool):
    ...
    # *** 특정 로거의 레벨 조정 ***
    logging.getLogger('src.pipeline').setLevel(logging.WARNING)  # 마스킹 복원 로그 줄이기
